...
class Ui_SpatialInteractionModelsDialogBase(object):
    def setupUi(self, SpatialInteractionModelsDialogBase):
        ...
        self.gridLayout_3.addWidget(self.widget_2, 13, 0, 1, 2)
        ...
        self.group_reports = QtWidgets.QGroupBox(self.restrictions)
        self.group_reports.setObjectName("group_reports")
        self.gridLayout_16 = QtWidgets.QGridLayout(self.group_reports)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.check_exe_f = QtWidgets.QCheckBox(self.group_reports)
        self.check_exe_f.setObjectName("check_exe_f")
        self.gridLayout_16.addWidget(self.check_exe_f, 0, 0, 1, 1)
        self.check_exe_s = QtWidgets.QCheckBox(self.group_reports)
        self.check_exe_s.setObjectName("check_exe_s")
        self.gridLayout_16.addWidget(self.check_exe_s, 0, 1, 1, 1)
        self.check_lineas = QtWidgets.QCheckBox(self.group_reports)
        self.check_lineas.setObjectName("check_lineas")
        self.gridLayout_16.addWidget(self.check_lineas, 1, 0, 1, 2)
        self.gridLayout_3.addWidget(self.group_reports, 8, 0, 1, 2)
        ...
        self.matrix_check = QtWidgets.QCheckBox(self.groupBox_4)
        self.matrix_check.setObjectName("matrix_check")
        self.gridLayout_8.addWidget(self.matrix_check, 1, 1, 1, 1)
        ...
        self.origin_combobox.layerChanged['QgsMapLayer*'].connect(self.id_origin_combobox.setLayer)
        self.origin_combobox.layerChanged['QgsMapLayer*'].connect(self.field_origin_combobox.setLayer)
        self.dest_combobox.layerChanged['QgsMapLayer*'].connect(self.id_dest_combobox.setLayer)
        self.dest_combobox.layerChanged['QgsMapLayer*'].connect(self.field_dest_combobox.setLayer)
    ...
    def retranslateUi(self, SpatialInteractionModelsDialogBase):
        ...
        self.groupBox_6.setToolTip(_translate("SpatialInteractionModelsDialogBase", "<html><head/><body><p align=\"justify\"><span style=\" background-color:transparent;\">Archivo que corresponde a la oferta, este archivo es de tipo punto y su estructura más básica es la siguiente: </span></p><p align=\"justify\"><span style=\" font-weight:600; background-color:transparent;\">ID: </span><span style=\" background-color:transparent;\">Identificador o clave única correspondiente para cada punto. Este atributo es obligatorio y alfanumérico. </span></p><p align=\"justify\"><span style=\" font-weight:600; background-color:transparent;\">Capacidad: </span><span style=\" background-color:transparent;\">Valor numérico entero mayor que cero, que muestra la capacidad total que tiene cada unidad de servicio, ya sea el número disponible de camas en un hospital, el número de lugares disponibles en una escuela, etc. Este atributo es obligatorio. </span></p><p align=\"justify\"><span style=\" font-weight:600; background-color:transparent;\">Nombre:</span><span style=\" background-color:transparent;\"> Además del ID, cada punto puede contener un nombre, este nombre puede ser el del establecimiento, el nombre de la unidad médica, etc. Este atributo es opcional y del tipo texto.</span></p></body></html>"))
        ...
        self.filt_combobox.setToolTip(_translate("SpatialInteractionModelsDialogBase", "<html><head/><body><p>1. Usa la distancia como evaluación</p><p>2. Identifica los posibles flujos que recibe una unidad</p><p>3. Realiza una combinación de ambos.</p></body></html>"))
        ...
        self.tipo_filt_dist.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Existen 3 formas de filtrar la distancia a evaluar."))
        ...
        self.val2_dist.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Valor númerico."))
        ...
        self.val2_fluj.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Valor númerico."))
        self.val2_fluj.setPlaceholderText(_translate("SpatialInteractionModelsDialogBase", "Segundo valor"))
        self.val1_fluj.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Valor númerico."))
        self.val1_fluj.setPlaceholderText(_translate("SpatialInteractionModelsDialogBase", "Primer valor"))
        self.tipo_filt_fluj.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Existen 3 formas de filtrar los flujos a evaluar."))
        ...
        self.measure_combobox.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Hay 5 unidades de medidAbrir explorador de archivosa para calcular distancias."))
        ...
        self.friction_distance.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Parámetro númerico que representa la atracción o repulsión de la atractividad."))
        ...
        self.group_reports.setTitle(_translate("SpatialInteractionModelsDialogBase", "Reportes y capas"))
        self.check_exe_f.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Genera resultados puntuales."))
        self.check_exe_f.setText(_translate("SpatialInteractionModelsDialogBase", "General (Ejecución rápida)"))
        self.check_exe_s.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Genera resultados específicos por cada unidad evaluada."))
        self.check_exe_s.setText(_translate("SpatialInteractionModelsDialogBase", "Completo (Demanda recursos y tiempo)"))
        self.check_lineas.setText(_translate("SpatialInteractionModelsDialogBase", "Generar capa de líneas (Demanda recursos y tiempo)"))
        ...
        self.prefijo.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Los prefijos permiten diferenciar las distintas ejecuciones del modelo"))
        ...
        self.geojson_check.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Genera archivos GeoJSON con la información crGenera un archivo SQLite con la información creada por el modeloeada por el modelo."))
        ...
        self.sqlite_check.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Genera archivos SQLite con la información creada por el modelo."))
        ...
        self.memory_check.setText(_translate("SpatialInteractionModelsDialogBase", "Solo temporales"))
        ...
        self.matrix_check.setToolTip(_translate("SpatialInteractionModelsDialogBase", "Crea un CSV con la matriz de interacción espacial calculada."))
        self.matrix_check.setText(_translate("SpatialInteractionModelsDialogBase", "Guardar Matriz de Interacción Espacial"))
