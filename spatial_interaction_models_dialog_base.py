...
class Ui_SpatialInteractionModelsDialogBase(object):
    def setupUi(self, SpatialInteractionModelsDialogBase):
        ...
        SpatialInteractionModelsDialogBase.resize(624, 521)
        SpatialInteractionModelsDialogBase.setMinimumSize(QtCore.QSize(624, 521))
        SpatialInteractionModelsDialogBase.setMaximumSize(QtCore.QSize(624, 521))
        ...
        self.frame = QtWidgets.QFrame(self.inputs)
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.frame)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.btn_sig1 = QtWidgets.QPushButton(self.frame)
        ...
        self.gridLayout_9.addWidget(self.btn_sig1, 2, 1, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/plugins/spatial_interaction_models/question_sq.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_ayuda1.setIcon(icon)
        ...
        self.gridLayout_2.addWidget(self.origin_combobox, 2, 0, 1, 2)
        self.dest_combobox = gui.QgsMapLayerComboBox(self.inputs)
        ...
        self.gridLayout_2.addWidget(self.dest_combobox, 8, 0, 1, 2)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plugins/spatial_interaction_models/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_output.setIcon(icon1)
        ...
        self.gridLayout_6.addWidget(self.frame_3, 8, 0, 1, 2)
