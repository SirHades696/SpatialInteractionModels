...
class Ui_SpatialInteractionModelsDialogBase(object):
    def setupUi(self, SpatialInteractionModelsDialogBase):
        ...
        self.check_projects = QtWidgets.QCheckBox(self.groupBox_7)
        self.check_projects.setObjectName("check_projects")
        self.gridLayout_14.addWidget(self.check_projects, 0, 0, 1, 1)
        self.projects_combobox = QtWidgets.QComboBox(self.groupBox_7)
        self.projects_combobox.setObjectName("projects_combobox")
        self.gridLayout_14.addWidget(self.projects_combobox, 0, 1, 1, 1)
